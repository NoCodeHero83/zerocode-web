            ...
            return (
              ...
              >
                <div className="relative overflow-hidden rounded-t-[16px] bg-[radial-gradient(ellipse_at_top_left,_rgba(99,102,241,0.06)_0%,_rgba(0,220,252,0.03)_40%,_transparent_70%)] px-8 pt-8">
                  <div className={`relative h-[300px] overflow-hidden rounded-xl shadow-[0_8px_40px_-8px_rgba(0,220,252,0.2)] ring-1 ring-white/10 ${isMobile ? 'mx-auto w-[65%]' : '-mx-8 w-full sm:mx-auto sm:w-[85%]'}`}>
