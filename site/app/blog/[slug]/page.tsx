...
import { blogPostsEn, getBlogPost } from '@/lib/content/blog-posts'
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: `/blog/${post.slug}/`,
        es: `/es/blog/${post.slug === 'eliminate-operational-bottlenecks' ? 'cuellos-de-botella-operativos' : post.slug === 'no-code-vs-low-code-vs-ai-assisted-development' ? 'no-code-vs-low-code-vs-desarrollo-asistido-ia' : post.slug === 'web-app-development-cost-guide' ? 'guia-costos-desarrollo-aplicaciones-web' : post.slug === 'replace-saas-tools-custom-software' ? 'reemplazar-saas-con-software-personalizado' : post.slug}/`,
      },
    },
    openGraph: {
      title: post.title,
      description: post.description,
      url: `https://zerocode.la/blog/${post.slug}/`,
      type: 'article',
    },
  }
}
    ...
    <>
      ...
      <main className="relative overflow-hidden">
        <div className="zc-back-nav">
          <Link href="/blog/" className="zc-back-btn">All Articles</Link>
        </div>
