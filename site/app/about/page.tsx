...
export const metadata: Metadata = {
  title: 'About Zerocode — AI-Assisted Software Development Agency',
  description: 'Learn about Zerocode\'s mission, team, and core values. We help established businesses eliminate operational bottlenecks with custom AI-assisted software.',
}
  ...
  return (
    <>
      ...
      <main className="relative overflow-hidden">
        ...
        <FinalCta content={{ href: content.contact.href }} locale="en" />
      </main>
      <Footer locale="en" />
    </>
  )
