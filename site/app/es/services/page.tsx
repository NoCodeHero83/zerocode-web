...
const content = servicesContent.es
const shared = homeContent.es

export const metadata: Metadata = {
  title: 'Servicios — Desarrollo de Software Asistido por IA | Zerocode',
  description: 'Ofrecemos desarrollo de aplicaciones web, móviles, soluciones de IA, diseño y prototipado, aumento de personal y gestión de proyectos.',
}
