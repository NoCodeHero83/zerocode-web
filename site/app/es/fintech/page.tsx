...
const content = fintechContent.es

export const metadata: Metadata = {
  title: 'Soluciones Fintech — App Bancaria, Billetera Virtual y Core | Zerocode',
  description:
    'Soluciones fintech probadas listas como white-label / SaaS: App Bancaria, Billetera Virtual (React Native + Supabase) y Core Bancario multipropósito. Lanza más rápido con Zerocode.',
  alternates: {
    canonical: '/es/fintech/',
    languages: {
      en: '/fintech/',
      es: '/es/fintech/',
    },
...
export default function FintechPageEs() {
  return (
    <>
      <Header locale="es" />
