...
export const metadata: Metadata = {
  ...
  description: 'Aplicaciones web, móviles, automatizaciones con IA y aumento de equipo. Precios fijos por hitos, propiedad total del código, sin dependencia de proveedores.',
}
