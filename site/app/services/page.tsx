...
export const metadata: Metadata = {
  title: 'Services — AI-Assisted Software Development | Zerocode',
  description: 'We offer web app development, mobile app development, AI solutions, design & prototyping, staff augmentation, and project management.',
}
