...
Estructura de las descripciones de los proyectos para la versión final del sitio web. Se incluye el contenido en inglés y español.

Orden de visualización en el sitio:
1. Later Life Training
2. Alianza Capital
3. Hulp — Clientes
4. Hulp — Proveedores
5. El resto en el orden actual (GM Parts, Daily Sparkle, Ecumerca, Mentor GrowthRockstar, Beauty Connect, El Tablero de Decisiones, CRM de Ventas Supra, Tok&Go)

Formato de la sección de beneficios de negocio (businessCase):
- **El problema** (subtítulo) → viñeta con la descripción del problema
- **Lo que construimos** (subtítulo) → viñetas de segundo nivel (una por item)
- **El resultado** (subtítulo) → viñetas de segundo nivel (una por resultado)
- *Cita entre comillas*
- **Enlaces** (subtítulo) → una viñeta por enlace

---

## 1. Later Life Training

**EN — From an unstable build to a fully operational platform in 6 months.**
Sector: Healthcare / Training & Education · Scotland
...
Sector: Atención de salud / Entrenamientos y Educación · Escocia
...
**EN — From 100% manual operations to a complete fintech platform in 12 months.**
Sector: Fintech · Colombia
...
**ES — De operaciones 100% manuales a una plataforma fintech completa en 12 meses.**
Sector: Fintech · Colombia
...
**EN — Service marketplace · Home services · Latin America**
...
- *"Zerocode let us go from a manual operation to a platform that now sustains our growth."*
- **Links**
  - Apple Store — https://apps.apple.com/pe/app/hulp-servicios-confiables/id6749599177
  - Google Play — https://play.google.com/store/apps/details?id=com.hulp.hulp

**ES — Marketplace de servicios · Servicios domésticos · Latinoamérica**
...
- *"Zerocode nos permitió pasar de una operación manual a una plataforma que hoy sostiene nuestro crecimiento."*
- **Enlaces**
  - Apple Store — https://apps.apple.com/pe/app/hulp-servicios-confiables/id6749599177
  - Google Play — https://play.google.com/store/apps/details?id=com.hulp.hulp
...
**EN — Service marketplace · Home services · Latin America (Provider side)**
...
- *"Zerocode let us go from a manual operation to a platform that now sustains our growth."*
- **Links**
  - Google Play (Providers) — https://play.google.com/store/apps/details?id=com.hulp.talentohulp
  - Apple Store (Providers) — https://apps.apple.com/pe/app/talento-hulp/id6748622356

**ES — Marketplace de servicios · Servicios domésticos · Latinoamérica (Lado proveedores)**
...
- *"Zerocode nos permitió pasar de una operación manual a una plataforma que hoy sostiene nuestro crecimiento."*
- **Enlaces**
  - Google Play (Proveedores) — https://play.google.com/store/apps/details?id=com.hulp.talentohulp
  - Apple Store (Proveedores) — https://apps.apple.com/pe/app/talento-hulp/id6748622356
