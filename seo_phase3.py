...
BLOG_CSS = """
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .zc-hero {
      background: #000000;
      background-image: radial-gradient(ellipse at 50% 0%, rgba(38,39,122,0.6) 0%, transparent 60%);
    ...
    /* BLUF */
    .zc-bluf {
      background: rgba(0,220,252,0.05);
      border: 1px solid rgba(0,220,252,0.2);
      padding: 32px 36px;
      margin: 0 0 56px;
      border-radius: 20px;
    }
...
<div class="zc-back-nav">
  <a href="/blog/" class="zc-back-btn">All Articles</a>
</div>
