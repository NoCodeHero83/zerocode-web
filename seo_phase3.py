...
BLOG_CSS = """
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .zc-breadcrumb a { color: var(--muted); text-decoration: none; transition: color .2s; }
    ...
    .zc-hero {
      background: #000000;
      background-image: radial-gradient(ellipse at 50% 0%, rgba(38,39,122,0.55) 0%, transparent 65%);
    ...
    /* CTA BLOCK — two-column video + text */
    .zc-cta {
      background: #000000;
      background-image: radial-gradient(ellipse at 30% 50%, rgba(38,39,122,0.55) 0%, transparent 65%);
      padding: 96px 48px;
      border-top: 1px solid var(--border);
    }
    .zc-cta-inner {
    ...
    .zc-cta-video {
      ...
      box-shadow: 0 0 60px rgba(0,220,252,0.1);
      aspect-ratio: 16/9;
      background: #0A0A14;
    }
    .zc-cta-video video { width: 100%; height: 100%; object-fit: cover; display: block; }
    .zc-cta-tag {
      display: inline-block;
      color: var(--cyan);
      font-family: 'Inter', sans-serif;
    ...
    .zc-cta-list li::before { content: "\\2713"; color: var(--cyan); font-weight: 700; position: absolute; left: 0; }
    .zc-cta a.btn, .zc-cta-text a.btn {
      display: inline-block;
    ...
    .zc-cta a.btn:hover, .zc-cta-text a.btn:hover {
      background: rgba(56,189,248,0.35);
      transform: translateY(-2px);
      box-shadow: 0 8px 32px rgba(0,220,252,0.2);
    }

    /* FORM SECTION */
    .zc-form-section {
      background: #020208;
      background-image: radial-gradient(ellipse at 70% 50%, rgba(38,39,122,0.4) 0%, transparent 65%);
      padding: 96px 48px;
      border-top: 1px solid var(--border);
    }
    .zc-form-inner {
    ...
    .zc-form input::placeholder, .zc-form textarea::placeholder { color: rgba(255,255,255,0.35); }
    .zc-form select { color: rgba(255,255,255,0.6); cursor: pointer; }
    .zc-form select option { background: #111827; color: #FFFFFF; }
    .zc-form input:focus, .zc-form select:focus, .zc-form textarea:focus {
      border-color: rgba(0,220,252,0.5);
      background: rgba(255,255,255,0.08);
    }
    .zc-form textarea { resize: vertical; min-height: 120px; line-height: 1.6; }
    ...
    .zc-blog-card:hover { transform: translateY(-5px); border-color: rgba(0,220,252,0.35); box-shadow: 0 16px 48px rgba(0,220,252,0.08); }
    .zc-blog-card-top {
      background: #0A0F1E;
    ...
    @media(max-width: 900px) {
      .zc-cta-inner { grid-template-columns: 1fr; gap: 40px; }
      .zc-cta-video { max-width: 560px; margin: 0 auto; width: 100%; }
      .zc-form-inner { grid-template-columns: 1fr; gap: 40px; }
      .zc-form-row { grid-template-columns: 1fr; }
    }
    @media(max-width: 768px) {
      .zc-nav { padding: 0 20px; }
      .zc-nav-links { display: none; }
      .zc-hero { padding: 64px 20px 52px; }
      ...
      .zc-cta { padding: 64px 20px; }
      .zc-cta-text h2 { font-size: 26px; }
      .zc-form-section { padding: 64px 20px; }
