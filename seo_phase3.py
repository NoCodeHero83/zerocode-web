...
BLOG_CSS = """
  ...
  <link href="https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@400;600;700;800&family=Roboto+Flex:wght@400;500;600&family=Inter:wght@400;500;600&display=swap" rel="stylesheet">
  <style>
    :root {
      --navy: #26277A;
      --cyan: #00DCFC;
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .zc-nav-logo img { height: 36px; display: block; }
    .zc-nav-links { display: flex; gap: 32px; list-style: none; align-items: center; }
    .zc-nav-links a {
    ...
    .zc-nav-cta:hover { background: rgba(56,189,248,0) !important; border-color: rgba(56,189,248,0.32) !important; }
    ...
    .zc-breadcrumb a { color: var(--muted); text-decoration: none; }
    .zc-breadcrumb a:hover { color: var(--cyan); }
    .zc-breadcrumb span { margin: 0 8px; color: rgba(255,255,255,0.3); }

    /* HERO */
    .zc-hero {
      background: #000000;
      background-image: radial-gradient(ellipse at 50% 0%, rgba(38,39,122,0.5) 0%, transparent 70%);
    ...
    .zc-hero .tag {
      ...
      letter-spacing: .15em;
      text-transform: uppercase;
      border: 1px solid rgba(0,220,252,0.35);
      padding: 5px 16px;
      border-radius: 50px;
      margin-bottom: 24px;
    }
    ...
    .zc-article p { margin-bottom: 22px; color: rgba(255,255,255,0.8); font-size: 17px; line-height: 1.8; }
    .zc-article ul, .zc-article ol { margin: 0 0 22px 26px; }
    .zc-article li { margin-bottom: 10px; color: rgba(255,255,255,0.8); font-size: 17px; }
    .zc-article strong { color: var(--cyan); font-weight: 600; }

    /* BLUF */
    .zc-bluf {
      background: rgba(0,220,252,0.06);
    ...
    .zc-bluf p { margin: 0; font-size: 16px; font-weight: 400; color: rgba(255,255,255,0.85); }
    ...
    .zc-stat .desc { font-size: 15px; line-height: 1.6; color: rgba(255,255,255,0.8); }
    .zc-stat .source { font-size: 12px; color: rgba(255,255,255,0.4); margin-top: 6px; }

    /* TABLE */
    .zc-table-wrap { overflow-x: auto; margin: 36px 0; border-radius: 12px; border: 1px solid var(--border); }
    .zc-table { width: 100%; border-collapse: collapse; font-size: 15px; }
    .zc-table th { background: #0F172A; color: var(--cyan); padding: 14px 18px; text-align: left; font-family: 'Inter', sans-serif; font-weight: 600; font-size: 13px; letter-spacing: 0.05em; text-transform: uppercase; }
    .zc-table td { padding: 13px 18px; border-bottom: 1px solid var(--border); vertical-align: top; color: rgba(255,255,255,0.8); }
    .zc-table tr:last-child td { border-bottom: none; }
    .zc-table tr:nth-child(even) td { background: rgba(255,255,255,0.025); }
    ...
    .zc-box h3 { margin-top: 0; color: #FFFFFF; }
    ...
    .zc-cta {
      background: #000000;
      background-image: radial-gradient(ellipse at 50% 100%, rgba(38,39,122,0.6) 0%, transparent 70%);
      color: #fff;
      padding: 80px 48px;
      text-align: center;
      border-top: 1px solid var(--border);
    }
    .zc-cta h2 { font-family: 'Space Grotesk', sans-serif; font-size: 36px; font-weight: 700; margin-bottom: 16px; letter-spacing: -0.5px; }
    .zc-cta p { font-size: 18px; color: rgba(255,255,255,0.7); max-width: 580px; margin: 0 auto 28px; }
    .zc-cta-points {
      display: flex;
      gap: 28px;
      justify-content: center;
    ...
    .zc-cta-points span { font-size: 15px; color: rgba(255,255,255,0.75); }
    ...
    .zc-cta a.btn:hover { background: rgba(56,189,248,0.15); transform: translateY(-2px); }
    ...
    .zc-footer-links a { color: rgba(255,255,255,0.5); text-decoration: none; }
    .zc-footer-links a:hover { color: var(--cyan); }
    ...
    .zc-blog-intro h2 { font-family: 'Space Grotesk', sans-serif; font-size: 28px; font-weight: 700; color: #FFFFFF; margin-bottom: 14px; letter-spacing: -0.5px; }
    .zc-blog-intro p { color: rgba(255,255,255,0.6); font-size: 17px; }
    .zc-blog-grid {
      display: grid;
    ...
    .zc-blog-card:hover { transform: translateY(-4px); border-color: rgba(0,220,252,0.4); box-shadow: 0 12px 40px rgba(0,220,252,0.08); }
    .zc-blog-card-top {
      background: #0F172A;
    ...
    .zc-blog-card-top h2 { font-family: 'Space Grotesk', sans-serif; font-size: 18px; font-weight: 600; line-height: 1.4; color: #FFFFFF; }
    .zc-blog-card-body { padding: 22px 28px 28px; }
    .zc-blog-card-body p { font-size: 14px; color: rgba(255,255,255,0.55); margin-bottom: 18px; line-height: 1.65; }
